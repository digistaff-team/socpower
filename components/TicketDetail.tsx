...
import { Send, User as UserIcon, Shield, Bot, Loader2, Lock } from 'lucide-react';
...
const TicketDetail: React.FC<TicketDetailProps> = ({ ticket, messages, currentUser, onStatusChange, onSendMessage }) => {
  ...
  const handleGenerateReply = async () => {
    ...
    if (!lastUserMsg && !ticket.description) return;
